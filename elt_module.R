...
dbGetQuery(con, "Drop table if exists FactSales_2")
dbGetQuery(con,"CREATE TABLE IF NOT EXISTS FactSales_2(area_code string, depression_id int, time_id string,
...
dbGetQuery(con, "Drop table if exists Fact_Crime")
